                    ...
                    <div class="table-responsive">
                        <table class="table data-thumb-view">
                            ...
                            @foreach($skills as $skill)
                                <tr>
                                    <td></td>
                                    <td class="product-img"><img src="{{ asset($skill->icon) }}" alt="Icon" style="width:50px;height:50px;object-fit:cover;"></td>
                                    <td class="product-name">{{ $skill->name }}</td>
                                    <td class="product-category">{{ Str::limit($skill->description, 50) }}</td>
                                    <td>
                                        <div class="chip chip-{{ $skill->status ? 'success' : 'danger' }}">
                                            <div class="chip-body">
                                                <div class="chip-text">{{ $skill->status ? 'Active' : 'Inactive' }}</div>
                                            </div>
                                        </div>
                                    </td>
                    ...
                    <div class="add-new-data-sidebar">
                        ...
                        <div class="add-new-data">
                            <div class="div mt-2 px-2 d-flex new-data-title justify-content-between">
                                <div><h4 class="text-uppercase">Skill Data</h4></div>
